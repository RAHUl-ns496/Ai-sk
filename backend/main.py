...
# ---------- CONFIG ----------
# ---------- CONFIG ----------
# Point to 'AI skin lession' which is two levels up from 'skin/backend'
BASE_DIR = os.path.abspath(os.path.join(os.path.dirname(os.path.abspath(__file__)), "..", ".."))

MODEL_PATH = os.path.join(BASE_DIR, "ai_model", "final_skin_model_B2_90plus.keras")
CLASS_JSON = os.path.join(BASE_DIR, "ai_model", "class_names.json")
...
if not os.path.exists(CLASS_JSON):
    log.warning("class_names.json not found; falling back to default names.")
...
try:
    ...
    IMG_SIZE = 260  # fallback (B2 default)
...
def dashboard():
    ...
    """
    # Assuming 'collection' is globally defined and connected:
    # if collection is None:
    #     return {"error": "Database collection is not available."}
